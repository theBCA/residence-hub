...
class _$AnnouncementImpl implements _Announcement {
  ...
  @override
  String toString() {
    return 'Announcement(id: $id, title: $title, body: $body, imageUrl: $imageUrl, priority: $priority, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, body, imageUrl, priority, createdAt);
...
abstract class _Announcement implements Announcement {
  const factory _Announcement(
      ...
      final String? imageUrl,
      final String? priority,
      required final DateTime createdAt}) = _$AnnouncementImpl;
